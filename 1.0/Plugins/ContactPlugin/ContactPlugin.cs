...
namespace ContactPlugin.Framework
{
    /// <summary>
    ...
    [MvcPluginMetadata("plugin-Contact", null, "Contact Plugin", "This is a plugin to start with as a base.")]
    public class ContactPlugin : BaseMvcPlugin
    {
        public override void SetupExtensions(IMvcPluginApplication app)
        {
            ...
            //AddActionFilter("Metatags", "PluginBase", new ActionExtension("Metatags", "Contact"));
            ...
            DefineWidget(new Widget("ContactPlugin.BasicForm", "Contact Form", "Contact", "BasicForm"));
        }
    }
}
